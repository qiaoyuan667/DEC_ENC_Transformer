...
class Model(nn.Module):
    ...
    def forecast(self, x_enc, input_len, x_mark_enc, x_dec, x_mark_dec, mask=None):
        
        #x_enc = x_enc[:, :input_len, :]  # 调整输入序列长度
    ...
    def forward(self, x_enc, input_len, x_mark_enc, x_dec, x_mark_dec, mask=None):
        if self.task_name == 'forecast':
            dec_out = self.forecast(x_enc, input_len, x_mark_enc, x_dec, x_mark_dec)
